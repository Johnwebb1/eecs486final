...
if __name__ == "__main__":
    ...
    naivebayes_file = open('naivebayes.ouput', 'r')
    rocchio_file = open('rocchio.output.txt', 'r')
    knn_file = open('knn.ouput', 'r')
    ...
    groundTruthsFile = ""
    if sys.argv[1]:
        groundTruthsFile = open(sys.argv[1])
    else:
        print("Ground Truth Json file needed as input to program")
        quit()
    
    #groundTruthsFile = open('data/large5400.json')
    ...
    for tweetID in groundTruths:
        ...
        tweet_scores[tweetID] = getScores(text)
    print("finished tweet score calculations")
    ...
    for classifier in classifiers:
        ...
        print("finished", classifier, "accuracy/toxicity scores")

    # calculate precision / recall / f score
    for classifier in classifiers:
        print("starting", classifier, "precision/recall/f scores")
        totalPrecision = 0
        totalRecall = 0
        ...
        print("finished", classifier, "precision/recall/f scores")
